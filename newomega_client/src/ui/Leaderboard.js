...
export const Leaderboard = (props) => {
    const logsToLeaderboard = () => {
        ...
        _.each(props.logs, (log) => {
            ...
            playerData[defender].wins = 0;
            playerData[defender].losses = 0;
            playerData[attacker] = playerData[attacker] || {};
            playerData[attacker].wins = 0;
            playerData[attacker].losses = 0;
        ...
        _.each(playerData, (data, player) => {
            ...
            data.name = defender ? ethers.utils.parseBytes32String(defender.name) : 'Anonymous';
        });
